...
Set up Postgres and create databases for both the development server (dbname) and testing server (dbname-test)
...
4. Create a database called 'dbname' for the development connection & (dbname-test) for the testing connection
...
```
    ...
    POSTGRES_TEST_DATABASE=dbname-test
```
